			...
			<form action="${pageContext.request.contextPath}/user/updatePassword"method="post">
				...
				<section class="content">
					...
					<table id="dataList"
							...
							<tbody>
								<td><input type="text" name="old" class="form-control"><span
										class="glyphicon glyphicon-envelope form-control-feedback"></span></td>
							<td> <input type="text" name="password" class="form-control"><span
									class="glyphicon glyphicon-envelope form-control-feedback"></span></td>
							</tbody>
